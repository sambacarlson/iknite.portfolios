  ...
  return (
    <footer className='bg-darker text-light text-sm p-4 flex flex-col'>
      ...
      <div className="flex flex-row space-x-3 items-center justify-center ">
        <div className="flex items-end h-12 w-12"><img src={mountainhublogo} alt="mountain hub logo" className='object-cover' /></div>
        <div className="flex items-end h-12 w-12"><img src={iknitestudiologo} alt="iknite studio logo" className='object-cover' /></div>
        <div className="flex items-end h-12 w-12"><img src={bohikorlogo} alt="bohikor logo" className='object-cover' /></div>
        <div className='flex items-end h-12 w-12'><img src={iknitelogo} alt="inkite logo" className='object-cover' /></div>
        <div className="flex items-end h-12 w-12"><img src={kuelaplogo} alt="kuelap logo" className='object-cover' /></div>
      </div>

      <hr className='text-dark mt-5'/>

      <div className="pt-5 pb-3 flex flex-row items-center justify-center space-x-3">
          <a href="#" className='hover:ring-1 hover:ring-light p-1 active:ring-dark'>Profiles</a>
          <a href="#" className='hover:ring-1 hover:ring-light p-1 active:ring-dark'>Projects</a>
          <a href="#" className='hover:ring-1 hover:ring-light p-1 active:ring-dark'>Contact</a>
      </div>
      <hr className='text-dark my-4 pb-2'/>
      <div className='grid grid-cols-5 gap-1 justify-center items-center'>
        <h4 className="col-span-2 font-bold">Subscribe to our weekly newsletter</h4>
        <div className='col-span-3 flex flex-row items-center justify-end ring-1 ring-dark bg-light rounded-sm p-1'>
