  ...
  return (
    <div>
      ...
      <div className='mt-5 flex flex-col md:flex-row'>
        <div className='border-b-[1px] border-b-reddish mb-8 w-full items-center py-6 md:flex md:flex-col md:w-1/4 md:bg-transparent md:border-light md:border-r-2'>
          <div className='flex flex-col items-center space-y-3'>
            <h3 className='text-base md:font-bold'><span className='text-reddish'>IKNITE</span> TEAM</h3>
            <div className='hidden md:flex flex-row items-center justify-center space-x-2 mb-4'>
